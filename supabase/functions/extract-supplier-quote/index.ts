...
async function callAI(
  ...
  if (!aiResp.ok) {
    ...
    // Tenta extrair "Please try again in Xs" do erro 429
...
2) Se há coluna UNITÁRIO na tabela do fornecedor, use direto. fator_conversao=1.
3) Se só há preço por embalagem, CALCULE valor_unitario = preço/conteúdo (ex.: CX c/12 R$120 → 10). Devolva o RESULTADO numérico, NUNCA "120/12".
4) Procure embalagem na descrição: "C/500", "10X500", "FD/12", "CX 24", "GL 5L".
