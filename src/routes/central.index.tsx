...
function CentralIndex() {
  ...
  const stats = useMemo(() => {
    ...
    for (const it of items) {
      ...
      // Custo escolhido: do preço do response selecionado
      let custo = Number(it.valor_unitario) || 0;
      ...
      const final = custo * (1 + margem / 100);
      totalCotado += final * qt;
      lucroTotal += (final - custo) * qt;
